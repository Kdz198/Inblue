...
public class MailController {
    ...
    @Operation(summary = "Gửi email quản trị", description = "Gửi email từ tài khoản quản trị hệ thống đến một địa chỉ nhận nhất định (phương thức GET, ném ngoại lệ nếu lỗi).")
    @GetMapping("/send")
    ...
    @Operation(summary = "Gửi email chung (Generic)", description = "API gửi email dùng chung, nhận payload chứa địa chỉ nhận, tiêu đề và nội dung email. Lỗi được xử lý nội bộ và trả về HTTP status tương ứng.")
