...
public class CompanyController {
    ...
    public ResponseEntity<Company> addCompany(@RequestPart("data") CreateCompanyRequest request, @RequestPart(value = "logo", required = false) MultipartFile logo,
    ...
    public ResponseEntity<Company> updateCompany(@RequestPart("data") UpdateCompanyRequest company,  @RequestPart(value = "logo", required = false) MultipartFile logo,
                                                 @RequestPart(value = "banner", required = false) MultipartFile banner) throws IOException {
