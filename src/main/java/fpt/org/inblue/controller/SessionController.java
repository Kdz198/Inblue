...
public class SessionController {
    ...
    @Operation(
            description =
                    "json mẫu tạo 1 session họp với mentor(privacy ,enable_recording ko cần cho chọn mà gửi ẩn là public,cloud về, name khỏi cần cho điền cứ gửi như json mẫu, còn lại thì cho người dùng chọn )",
    ...
    @Operation(
            ...
            summary = "SessionName gửi về là roomName trong session")
