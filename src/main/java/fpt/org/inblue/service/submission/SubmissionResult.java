...
public class SubmissionResult {
    ...
    private SubmissionResult(
            ...
            List<CompilerResponseDto.TestCaseResult> testCases) {
        this.status = status;
    ...
    public static SubmissionResult completed(ApplicationDetail detail) {
        return new SubmissionResult(
                ...
                detail,
                "Nộp bài thành công",
                detail.getFinalResult(),
                null);
    }

    public static SubmissionResult pending(Long applicationId) {
        return new SubmissionResult(
                Status.PENDING, applicationId, null, "Bài đang được chấm, vui lòng chờ", null, null);
    }

    public static SubmissionResult compileCode(CompilerResponseDto compilerResponse) {
        return new SubmissionResult(
                Status.PENDING, null, null, "Compile code thành công", null, compilerResponse.getTestCases());
    }
}
