...
import fpt.org.inblue.model.ApplicationDetail.RoundResult;
...
public class SubmissionService {
    ...
    public ApplicationDetail evaluateCodeReview(CodeReviewSubmitRequest request) {
        ...
        Round.CodeReviewProblemSnapshot problemSnapshot = currentRound.getConfigData().getCodeReviewProblems().get(0);
        ...
        CodeReviewEvaluationRequest.EvaluationCriteria criteriaDto = CodeReviewEvaluationRequest.EvaluationCriteria.builder()
        ...
        CodeReviewEvaluationRequest.CodeReviewProblem problemDto = CodeReviewEvaluationRequest.CodeReviewProblem.builder()
                .title(problemSnapshot.getTitle())
                .difficulty(problemSnapshot.getDifficulty() != null ? problemSnapshot.getDifficulty().name() : "MEDIUM")
        ...
        ApplicationDetail.SubmissionData submissionData = detail.getSubmissionData() != null ? detail.getSubmissionData() : new ApplicationDetail.SubmissionData();
