    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (!requestBody.isBlank()) {
            ...
            if (!parameterMap.isEmpty()) {
                ...
                parameterMap.forEach((key, value) -> formParams
                        .append(key)
                        .append("=")
                ...
                log.info(
                        "▶ Nhận API: [{} {}] - Payload Form-Data: {}",
                        request.getMethod(),
                        request.getRequestURI(),
                        formParams);
            } else {
                log.info("▶ Nhận API: [{} {}] - (Không có Request Body)", request.getMethod(), request.getRequestURI());
            }
        }
    }
}
